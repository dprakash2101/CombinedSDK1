...
```sh
pip install git+https://github.com/dprakash2101/CombinedSDK1.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/dprakash2101/CombinedSDK1.git`)
